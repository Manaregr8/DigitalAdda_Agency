...
export default function VideoTestimonialPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f0020] p-4 sm:p-6 lg:p-8">
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
          ...
          <div className="w-full lg:flex-1 relative rounded-2xl lg:rounded-3xl overflow-hidden bg-black/30 backdrop-blur-sm" style={{ height: isMobile ? '400px' : 'calc(100vh - 250px)' }}>
            ...
            <button
              ...
              className="absolute top-4 right-4 lg:top-6 lg:right-6 z-20 bg-black/70 hover:bg-black/90 text-white rounded-full p-2 shadow-lg transition-all border border-white/20"
              style={{ backdropFilter: 'blur(4px)' }}
              aria-label={isMuted ? 'Unmute video' : 'Mute video'}
            >
              {isMuted ? (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 9v6h4l5 5V4l-5 5H9z" /><line x1="19" y1="5" x2="5" y2="19" stroke="currentColor" strokeWidth="2"/></svg>
              ) : (
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-black/80 p-4 lg:p-8">
